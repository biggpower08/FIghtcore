...
const activeAnimations = [
  ...
  entry('ronin', 'Ronin', 'Roundhouse Kick', 'roundhouse_kick', { problem: true, visualActiveFrames: [5], impactFrame: 5 }),
  entry('ronin', 'Ronin', 'Side Kick', 'side_kick', { problem: true, visualActiveFrames: [4], impactFrame: 4 }),
