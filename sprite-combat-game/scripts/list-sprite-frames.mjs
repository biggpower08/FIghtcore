...
function printTable(items) {
  ...
  console.log('');
  console.log('Runtime priority: manual-overrides > frames-cleaned > frames-pack > frames-reference > frames-semi-realistic > raw fallback.');
...
function renderMarkdown(items) {
  ...
  lines.push('');
  lines.push('Runtime priority: `manual-overrides` > `frames-cleaned` > `frames-pack` > `frames-reference` > `frames-semi-realistic` > raw fallback.');
  lines.push('');
