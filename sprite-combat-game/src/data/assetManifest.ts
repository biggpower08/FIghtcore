...
export const artAssetManifest: ArtAssetManifestEntry[] = [
  ...
  },
  {
    ...
    type: 'enemy-sheet',
    status: 'partial',
    sourcePath: 'public/sprites/source-generated/cyber-monkey-scrapper-sheet.png',
    runtimePath: '/sprites/frames/cyber-monkey-scrapper/',
    notes: 'Generated scrapper art is sliced into runtime animation folders. Procedural fallback remains only if files are missing.',
  },
  {
    ...
    type: 'enemy-sheet',
    status: 'partial',
    sourcePath: 'public/sprites/source-generated/cyber-monkey-alpha-sheet.png',
    runtimePath: '/sprites/frames/cyber-monkey-alpha/',
    notes: 'Generated boss art is sliced into runtime animation folders. Procedural fallback remains only if files are missing.',
  },
  {
