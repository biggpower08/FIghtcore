...
export const fightcoreSpriteManifest: FightcoreSpriteManifestEntry[] = [
  ...
  },
  {
    ...
    animations: [
      ...
      animation('walk', 1, 6, true, 10),
      animation('dash', 2, 5, false, 14),
      animation('roundhouse_kick', 3, 7, false, 13),
      animation('teep_kick', 4, 6, false, 13),
      animation('cross', 5, 6, false, 14),
      animation('jab', 6, 5, false, 16),
      animation('hit_react', 7, 5, false, 12),
  ...
  },
  {
    ...
    atlasHeight: 864,
    animations: [
      animation('idle', 0, 6, true, 8),
      animation('run', 1, 5, true, 12),
      animation('jab', 2, 4, false, 14),
  ...
  },
  {
    ...
    animations: [
      ...
      animation('run', 1, 4, true, 11),
      animation('charge', 2, 5, false, 10),
      animation('dash', 3, 2, false, 14),
  ...
  },
  {
    ...
    animations: [
      ...
      animation('dash', 2, 6, false, 14),
      animation('palm_strike', 3, 6, false, 14),
      animation('high_kick', 4, 7, false, 13),
      animation('spinning_sweep', 5, 3, false, 12),
