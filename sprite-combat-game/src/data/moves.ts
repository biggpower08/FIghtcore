...
export const moves: MoveDefinition[] = [
  ...
  createMove('calf_kick', 'Calf Kick', 'kickboxing', 'common', 13, 12, 380, 68, 62, 30, 95, 100, 165, 110, 180, 1),
  createMove('knee', 'Knee', 'muay-thai', 'uncommon', 21, 18, 600, 48, 44, 58, 125, 105, 220, 150, 260, 2),
  ...
  createMove('duck_under_mat_return_slam', 'Duck Under Mat Return Slam', 'wrestling', 'epic', 34, 30, 1280, 70, 72, 56, 210, 150, 350, 310, 520, 4),
  ...
  createMove('jab_cross', 'Jab-Cross', 'boxing', 'rare', 30, 22, 720, 76, 68, 42, 125, 130, 260, 230, 330, 4, true),
  createMove('feint_rear_hook', 'Feint-Rear Hook', 'boxing', 'epic', 38, 28, 940, 72, 66, 48, 180, 120, 320, 290, 430, 5, true),
  createMove('tornado_kick', 'Tornado Kick', 'kickboxing', 'legendary', 48, 36, 1280, 104, 92, 58, 260, 160, 420, 390, 560, 6, true),
  ...
  createMove('density', 'Density', 'special', 'legendary', 0, 0, 12000, 0, 0, 0, 180, 2600, 300, 0, 0, 6, true, 'character'),
  createMove('instant_death', 'Instant Death', 'special', 'mythic', 0, 0, 16000, 0, 0, 0, 220, 4200, 360, 0, 0, 6, true, 'character'),
